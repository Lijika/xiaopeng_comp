"""Adapter: registration-certificate page_order JSON -> Application placeholders (no OCR text)."""
...
def main() -> None:
    ...
    p = argparse.ArgumentParser(description="Convert registration layout JSON to application schema")
